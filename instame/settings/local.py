"""Django settings for instame project.
...
SECRET_KEY = 'g(+9s)n8osl642z2!h(n7%h2f0dh_%m=lx10k4*2%2n-b8y(#%'
...
WSGI_APPLICATION = 'instame.wsgi.application'
